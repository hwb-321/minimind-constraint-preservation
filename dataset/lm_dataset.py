    ...
    def create_chat_prompt(self, conversations):
        ...
        for message in conversations:
            ...
            if "tool_calls" in normalized:
                normalized["tool_calls"] = parse_json_field(normalized["tool_calls"])
            if "tools" in normalized:
                normalized["tools"] = parse_json_field(normalized["tools"])
            if "functions" in normalized:
                normalized["functions"] = parse_json_field(normalized["functions"])
